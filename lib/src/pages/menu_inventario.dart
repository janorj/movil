...
void main() {
  ...
  runApp(Opcionnes_Inventario());
}

class Opcionnes_Inventario extends StatefulWidget {
  const Opcionnes_Inventario({
    Key key,
  }) : super(key: key);

  @override
  _Opcionnes_InventarioState createState() => _Opcionnes_InventarioState();
}

class _Opcionnes_InventarioState extends State<Opcionnes_Inventario> {
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          iconSize: 50,
                          onPressed: () {
                            Navigator.pushNamed(context, '/toma_inventario');
                          },
                        ),
                        Container(
